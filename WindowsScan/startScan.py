...
start_scan(token, hosts, host_groups, file_paths) #start scan
scan_id = start_scan(token, hosts[0], file_paths)
if scan_id:
    get_scan_details(token, scan_id) #get scan details
...
# get malicious file ids details!
